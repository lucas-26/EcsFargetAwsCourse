...
public class Service01Stack extends Stack {
    ...
    public Service01Stack(final Construct scope, final String id, final StackProps props, Cluster cluster) {
        ...
        envVariables.put("SPRING_DATASOURCE_URL", "jdbc:postgresql://" + Fn.importValue("rds-endpoint") + ":5432/aws_project01?createDatabaseIfNotExist=true");
                ...
                ApplicationLoadBalancedFargateService.Builder.create(this, "ALB01")
                        ...
                        .taskImageOptions(
                                ApplicationLoadBalancedTaskImageOptions.builder()
                                        ...
                                        .image(ContainerImage.fromRegistry("rocklucas/curso_aws_project01"))
                                        .containerPort(8080)
